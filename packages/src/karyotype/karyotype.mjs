...
function XD() {
  if (qx) return Fp;
  qx = 1;
  var H = Cf, K = Symbol.for("react.element"), k = Symbol.for("react.fragment"), it = Object.prototype.hasOwnProperty, we = H.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, Ve = { key: !0, ref: !0, __self: !0, __source: !0 };
  function g(Ae, J, Z) {
    var Oe, Y = {}, ee = null, I = null;
    Z !== void 0 && (ee = "" + Z), J.key !== void 0 && (ee = "" + J.key), J.ref !== void 0 && (I = J.ref);
    for (Oe in J) it.call(J, Oe) && !Ve.hasOwnProperty(Oe) && (Y[Oe] = J[Oe]);
    if (Ae && Ae.defaultProps) for (Oe in J = Ae.defaultProps, J) Y[Oe] === void 0 && (Y[Oe] = J[Oe]);
    return { $$typeof: K, type: Ae, key: ee, ref: I, props: Y, _owner: we.current };
  }
...
function KD() {
  return Zx || (Zx = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var tt = H.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    function Je(E) {
      {
    ...
    function Me(E, F, ae) {
      {
        var _e = tt.ReactDebugCurrentFrame, Qe = _e.getStackAddendum();
        Qe !== "" && (F += "%s", ae = ae.concat([Qe]));
        var Pe = ae.map(function(rt) {
          return String(rt);
        });
        Pe.unshift("Warning: " + F), Function.prototype.apply.call(console[E], console, Pe);
      }
    }
    var lt = !1, Fe = !1, Tt = !1, $e = !1, ln = !1, Ut;
    Ut = Symbol.for("react.module.reference");
    function en(E) {
      return !!(typeof E == "string" || typeof E == "function" || E === it || E === Ve || ln || E === we || E === Z || E === Oe || $e || E === I || lt || Fe || Tt || typeof E == "object" && E !== null && (E.$$typeof === ee || E.$$typeof === Y || E.$$typeof === g || E.$$typeof === Ae || E.$$typeof === J || // This needs to include all possible module reference object
      ...
      if (typeof E == "object")
        switch (E.$$typeof) {
          ...
          case Y:
            ...
            return _e !== null ? _e : G(E.type) || "Memo";
          case ee: {
            var Qe = E, Pe = Qe._payload, rt = Qe._init;
            try {
              return G(rt(Pe));
            } catch {
              return null;
    ...
    var ye = Object.assign, Xe = 0, pt, Ft, X, ge, q, Ze, nt;
    function Yn() {
    }
    ...
    function un() {
      {
        if (Xe === 0) {
          pt = console.log, Ft = console.info, X = console.warn, ge = console.error, q = console.group, Ze = console.groupCollapsed, nt = console.groupEnd;
          var E = {
            configurable: !0,
            enumerable: !0,
            value: Yn,
    ...
    function ta() {
      {
        ...
        Xe < 0 && Je("disabledDepth fell below zero. This is a bug in React. Please file an issue.");
      }
    }
...
` + et[Yt].replace(" at new ", " at ");
    ...
    var An = Object.prototype.hasOwnProperty, Ra = {}, ja = tt.ReactDebugCurrentFrame;
    function Ue(E) {
      if (E) {
    ...
    function At(E, F, ae, _e, Qe) {
      {
        ...
        for (var rt in E)
          if (Pe(E, rt)) {
            var et = void 0;
            try {
              if (typeof E[rt] != "function") {
                var On = Error((_e || "React class") + ": " + ae + " type `" + rt + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof E[rt] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw On.name = "Invariant Violation", On;
              }
              et = E[rt](F, rt, _e, ae, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (Yt) {
              et = Yt;
            }
            et && !(et instanceof Error) && (Ue(Qe), Je("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", _e || "React class", ae, rt, typeof et), Ue(null)), et instanceof Error && !(et.message in Ra) && (Ra[et.message] = !0, Ue(Qe), Je("Failed %s type: %s", ae, et.message), Ue(null));
          }
      }
    }
    ...
    function tn(E) {
      if (jn(E))
        return Je("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", Ot(E)), Nt(E);
    }
    var nn = tt.ReactCurrentOwner, Fn = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function ut(E, F) {
      {
        var ae = function() {
          gn || (gn = !0, Je("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", F));
        };
    ...
    function ht(E, F) {
      {
        var ae = function() {
          W || (W = !0, Je("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", F));
        };
    ...
    var Bt = function(E, F, ae, _e, Qe, Pe, rt) {
      var et = {
    ...
    function _n(E, F, ae, _e, Qe) {
      {
        var Pe, rt = {}, et = null, On = null;
        ae !== void 0 && (tn(ae), et = "" + ae), Be(F) && (tn(F.key), et = "" + F.key), ie(F) && (On = F.ref, Ge(F, Qe));
        for (Pe in F)
          An.call(F, Pe) && !Fn.hasOwnProperty(Pe) && (rt[Pe] = F[Pe]);
        if (E && E.defaultProps) {
          var Yt = E.defaultProps;
          for (Pe in Yt)
            rt[Pe] === void 0 && (rt[Pe] = Yt[Pe]);
        }
        if (et || On) {
          var Xt = typeof E == "function" ? E.displayName || E.name || "Unknown" : E;
          et && ut(rt, Xt), On && ht(rt, Xt);
        }
        return Bt(E, et, On, Qe, _e, nn.current, rt);
      }
    }
    var xt = tt.ReactCurrentOwner, ot = tt.ReactDebugCurrentFrame;
    function Ht(E) {
      if (E) {
        var F = E._owner, ae = on(E.type, E._source, F ? F.type : null);
    ...
    function cu(E, F) {
      {
        ...
        ro[ae] = !0;
        var _e = "";
        E && E._owner && E._owner !== xt.current && (_e = " It was passed a child from " + G(E._owner.type) + "."), Ht(E), Je('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', ae, _e), Ht(null);
      }
    }
    function fu(E, F) {
      {
        ...
        if (_t(E))
          ...
          if (typeof Qe == "function" && Qe !== E.entries)
            for (var Pe = Qe.call(E), rt; !(rt = Pe.next()).done; )
              na(rt.value) && cu(rt.value, F);
        }
      }
    }
    function io(E) {
    ...
    function br(E, F, ae, _e, Qe, Pe) {
      {
        ...
        if (!rt) {
          ...
          On ? et += On : et += gl();
          var Yt;
          E === null ? Yt = "null" : _t(E) ? Yt = "array" : E !== void 0 && E.$$typeof === K ? (Yt = "<" + (G(E.type) || "Unknown") + " />", et = " Did you accidentally export a JSX literal instead of a component?") : Yt = typeof E, Je("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", Yt, et);
        }
        var Xt = _n(E, F, ae, Qe, Pe);
        if (Xt == null)
          return Xt;
        if (rt) {
          var fr = F.children;
        ...
        if (An.call(F, "key")) {
          var oi = G(E), We = Object.keys(F).filter(function(lo) {
            return lo !== "key";
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, Ke, oi, si, oi), wa[oi + Ke] = !0;
          }
        }
        return E === it ? ii(Xt) : io(Xt), Xt;
      }
    }
    function Ai(E, F, ae) {
      return br(E, F, ae, !0);
    ...
    var ji = li, Fi = Ai;
    Hp.Fragment = it, Hp.jsx = ji, Hp.jsxs = Fi;
  }()), Hp;
}
process.env.NODE_ENV === "production" ? v0.exports = XD() : v0.exports = KD();
var me = v0.exports, h0 = { exports: {} }, Ca = {}, jm = { exports: {} }, d0 = {};
/**
 * @license React
...
function qD() {
  return Jx || (Jx = 1, function(H) {
    function K(X, ge) {
      ...
      X.push(ge);
      e: for (; 0 < q; ) {
        var Ze = q - 1 >>> 1, nt = X[Ze];
        if (0 < we(nt, ge)) X[Ze] = ge, X[q] = nt, q = Ze;
        else break e;
      }
    }
    function k(X) {
    ...
    function it(X) {
      ...
      if (q !== ge) {
        X[0] = q;
        e: for (var Ze = 0, nt = X.length, Yn = nt >>> 1; Ze < Yn; ) {
          var un = 2 * (Ze + 1) - 1, ta = X[un], hn = un + 1, mn = X[hn];
          if (0 > we(ta, q)) hn < nt && 0 > we(mn, ta) ? (X[Ze] = mn, X[hn] = q, Ze = hn) : (X[Ze] = ta, X[un] = q, Ze = un);
          else if (hn < nt && 0 > we(mn, q)) X[Ze] = mn, X[hn] = q, Ze = hn;
          else break e;
        }
      }
      return ge;
    ...
    function we(X, ge) {
      var q = X.sortIndex - ge.sortIndex;
      return q !== 0 ? q : X.id - ge.id;
    }
    ...
    var J = [], Z = [], Oe = 1, Y = null, ee = 3, I = !1, fe = !1, Te = !1, be = typeof setTimeout == "function" ? setTimeout : null, tt = typeof clearTimeout == "function" ? clearTimeout : null, Je = typeof setImmediate < "u" ? setImmediate : null;
    typeof navigator < "u" && navigator.scheduling !== void 0 && navigator.scheduling.isInputPending !== void 0 && navigator.scheduling.isInputPending.bind(navigator.scheduling);
    function Me(X) {
      for (var ge = k(Z); ge !== null; ) {
        if (ge.callback === null) it(Z);
        else if (ge.startTime <= X) it(Z), ge.sortIndex = ge.expirationTime, K(J, ge);
        else break;
        ge = k(Z);
      }
    }
    function lt(X) {
      if (Te = !1, Me(X), !fe) if (k(J) !== null) fe = !0, pt(Fe);
      else {
        var ge = k(Z);
        ge !== null && Ft(lt, ge.startTime - X);
      }
    }
    function Fe(X, ge) {
      fe = !1, Te && (Te = !1, tt(ln), ln = -1), I = !0;
      var q = ee;
      try {
        for (Me(ge), Y = k(J); Y !== null && (!(Y.expirationTime > ge) || X && !Wt()); ) {
          var Ze = Y.callback;
          if (typeof Ze == "function") {
            Y.callback = null, ee = Y.priorityLevel;
            var nt = Ze(Y.expirationTime <= ge);
            ge = H.unstable_now(), typeof nt == "function" ? Y.callback = nt : Y === k(J) && it(J), Me(ge);
          } else it(J);
          Y = k(J);
        }
        if (Y !== null) var Yn = !0;
          ...
          var un = k(Z);
          un !== null && Ft(lt, un.startTime - ge), Yn = !1;
        }
        return Yn;
      } finally {
        Y = null, ee = q, I = !1;
    ...
    var G;
    if (typeof Je == "function") G = function() {
      Je(Q);
    };
    else if (typeof MessageChannel < "u") {
      var ye = new MessageChannel(), Xe = ye.port2;
      ye.port1.onmessage = Q, G = function() {
        Xe.postMessage(null);
      };
    } else G = function() {
      be(Q, 0);
    ...
    H.unstable_IdlePriority = 5, H.unstable_ImmediatePriority = 1, H.unstable_LowPriority = 4, H.unstable_NormalPriority = 3, H.unstable_Profiling = null, H.unstable_UserBlockingPriority = 2, H.unstable_cancelCallback = function(X) {
      X.callback = null;
    ...
    }, H.unstable_runWithPriority = function(X, ge) {
      switch (X) {
        case 1:
        case 2:
        case 3:
    ...
    }, H.unstable_scheduleCallback = function(X, ge, q) {
      var Ze = H.unstable_now();
      switch (typeof q == "object" && q !== null ? (q = q.delay, q = typeof q == "number" && 0 < q ? Ze + q : Ze) : q = Ze, X) {
        case 1:
          var nt = -1;
          break;
        case 2:
      ...
      return nt = q + nt, X = { id: Oe++, callback: ge, priorityLevel: X, startTime: q, expirationTime: nt, sortIndex: -1 }, q > Ze ? (X.sortIndex = q, K(Z, X), k(J) === null && X === k(Z) && (Te ? (tt(ln), ln = -1) : Te = !0, Ft(lt, q - Ze))) : (X.sortIndex = nt, K(J, X), fe || I || (fe = !0, pt(Fe))), X;
    }, H.unstable_shouldYield = Wt, H.unstable_wrapCallback = function(X) {
      var ge = ee;
      return function() {
        var q = ee;
        ee = ge;
    ...
    process.env.NODE_ENV !== "production" && function() {
      ...
      function Ve(W) {
        if (W.length === 0)
          return null;
        var ie = W[0], Be = W.pop();
        return Be !== ie && (W[0] = Be, Ae(W, Be, 0)), ie;
      }
      function g(W, ie, Be) {
        for (var Ge = Be; Ge > 0; ) {
          var ut = Ge - 1 >>> 1, ht = W[ut];
          if (J(ht, ie) > 0)
            W[ut] = ie, W[Ge] = ht, Ge = ut;
          else
            return;
        }
      }
      function Ae(W, ie, Be) {
        for (var Ge = Be, ut = W.length, ht = ut >>> 1; Ge < ht; ) {
          var Bt = (Ge + 1) * 2 - 1, _n = W[Bt], xt = Bt + 1, ot = W[xt];
          if (J(_n, ie) < 0)
            xt < ut && J(ot, _n) < 0 ? (W[Ge] = ot, W[xt] = ie, Ge = xt) : (W[Ge] = _n, W[Bt] = ie, Ge = Bt);
          else if (xt < ut && J(ot, ie) < 0)
            W[Ge] = ot, W[xt] = ie, Ge = xt;
          else
            return;
        }
      }
      function J(W, ie) {
        var Be = W.sortIndex - ie.sortIndex;
        return Be !== 0 ? Be : W.id - ie.id;
      }
      ...
      var Me = 1073741823, lt = -1, Fe = 250, Tt = 5e3, $e = 1e4, ln = Me, Ut = [], en = [], Wt = 1, Q = null, G = Y, ye = !1, Xe = !1, pt = !1, Ft = typeof setTimeout == "function" ? setTimeout : null, X = typeof clearTimeout == "function" ? clearTimeout : null, ge = typeof setImmediate < "u" ? setImmediate : null;
      typeof navigator < "u" && navigator.scheduling !== void 0 && navigator.scheduling.isInputPending !== void 0 && navigator.scheduling.isInputPending.bind(navigator.scheduling);
      function q(W) {
        for (var ie = we(en); ie !== null; ) {
          if (ie.callback === null)
            ...
            Ve(en), ie.sortIndex = ie.expirationTime, it(Ut, ie);
          else
            return;
          ie = we(en);
        }
      ...
      function Ze(W) {
        if (pt = !1, q(W), !Xe)
          if (we(Ut) !== null)
            ...
            var ie = we(en);
            ie !== null && tn(Ze, ie.startTime - W);
          }
      }
      function nt(W, ie) {
        Xe = !1, pt && (pt = !1, nn()), ye = !0;
        var Be = G;
        try {
          var Ge;
          if (!K) return Yn(W, ie);
      ...
      function Yn(W, ie) {
        var Be = ie;
        for (q(Be), Q = we(Ut); Q !== null && !(Q.expirationTime > Be && (!W || ja())); ) {
          var Ge = Q.callback;
          if (typeof Ge == "function") {
            Q.callback = null, G = Q.priorityLevel;
            var ut = Q.expirationTime <= Be, ht = Ge(ut);
            Be = H.unstable_now(), typeof ht == "function" ? Q.callback = ht : Q === we(Ut) && Ve(Ut), q(Be);
          } else
            Ve(Ut);
          Q = we(Ut);
        }
        if (Q !== null)
          return !0;
        var Bt = we(en);
        return Bt !== null && tn(Ze, Bt.startTime - Be), !1;
      }
      function un(W, ie) {
        switch (W) {
          case Z:
      ...
      function mn(W, ie, Be) {
        var Ge = H.unstable_now(), ut;
        if (typeof Be == "object" && Be !== null) {
          var ht = Be.delay;
          typeof ht == "number" && ht > 0 ? ut = Ge + ht : ut = Ge;
        } else
          ut = Ge;
        var Bt;
        switch (W) {
        ...
        return ut > Ge ? (xt.sortIndex = ut, it(en, xt), we(Ut) === null && xt === we(en) && (pt ? nn() : pt = !0, tn(Ze, ut - Ge))) : (xt.sortIndex = _n, it(Ut, xt), !Xe && !ye && (Xe = !0, Nt(nt))), xt;
      }
      function kn() {
      }
      function ir() {
      ...
      var Gt = !1, bt = null, on = -1, An = k, Ra = -1;
      function ja() {
        var W = H.unstable_now() - Ra;
        return !(W < An);
      }
      function Ue() {
      }
      ...
      var Fn = Ue, gn = null;
      H.unstable_IdlePriority = I, H.unstable_ImmediatePriority = Z, H.unstable_LowPriority = ee, H.unstable_NormalPriority = Y, H.unstable_Profiling = gn, H.unstable_UserBlockingPriority = Oe, H.unstable_cancelCallback = yn, H.unstable_continueExecution = ir, H.unstable_forceFrameRate = At, H.unstable_getCurrentPriorityLevel = cr, H.unstable_getFirstCallbackNode = Un, H.unstable_next = ta, H.unstable_pauseExecution = kn, H.unstable_requestPaint = Fn, H.unstable_runWithPriority = un, H.unstable_scheduleCallback = mn, H.unstable_shouldYield = ja, H.unstable_wrapCallback = hn, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    }();
  }(p0)), p0;
}
var tT;
...
function JD() {
  ...
  var it = /* @__PURE__ */ new Set(), we = {};
  function Ve(n, r) {
    g(n, r), g(n + "Capture", r);
  }
  function g(n, r) {
    for (we[n] = r, n = 0; n < r.length; n++) it.add(r[n]);
  }
  ...
  var lt = H.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, Fe = Symbol.for("react.element"), Tt = Symbol.for("react.portal"), $e = Symbol.for("react.fragment"), ln = Symbol.for("react.strict_mode"), Ut = Symbol.for("react.profiler"), en = Symbol.for("react.provider"), Wt = Symbol.for("react.context"), Q = Symbol.for("react.forward_ref"), G = Symbol.for("react.suspense"), ye = Symbol.for("react.suspense_list"), Xe = Symbol.for("react.memo"), pt = Symbol.for("react.lazy"), Ft = Symbol.for("react.offscreen"), X = Symbol.iterator;
  function ge(n) {
    return n === null || typeof n != "object" ? null : (n = X && n[X] || n["@@iterator"], typeof n == "function" ? n : null);
  }
  var q = Object.assign, Ze;
  function nt(n) {
    if (Ze === void 0) try {
      throw Error();
    } catch (l) {
...
` + c[h].replace(" at new ", " at ");
    ...
    return (n = n ? n.displayName || n.name : "") ? nt(n) : "";
  }
  function ta(n) {
    switch (n.tag) {
      case 5:
  ...
  var ht = q({ menuitem: !0 }, { area: !0, base: !0, br: !0, col: !0, embed: !0, hr: !0, img: !0, input: !0, keygen: !0, link: !0, meta: !0, param: !0, source: !0, track: !0, wbr: !0 });
  function Bt(n, r) {
    if (r) {
  ...
  var Xt = K.unstable_scheduleCallback, fr = K.unstable_cancelCallback, ui = K.unstable_shouldYield, oi = K.unstable_requestPaint, We = K.unstable_now, Ke = K.unstable_getCurrentPriorityLevel, si = K.unstable_ImmediatePriority, lo = K.unstable_UserBlockingPriority, uo = K.unstable_NormalPriority, Bp = K.unstable_LowPriority, xf = K.unstable_IdlePriority, oo = null, ba = null;
  function Pp(n) {
  ...
  function po(n, r) {
    n.blockedOn === r && (n.blockedOn = null, dr || (dr = !0, K.unstable_scheduleCallback(K.unstable_NormalPriority, Ym)));
  }
  function Bi(n) {
    function r(c) {
      return po(c, n);
  ...
  var xl = lt.ReactCurrentBatchConfig, Tl = !0;
  function Yp(n, r, l, o) {
  ...
  var vo = null;
  function Os(n, r, l, o) {
    if (vo = null, n = ot(o), n = Nl(n), n !== null) if (r = Qe(n), r === null) n = null;
  ...
  }, defaultPrevented: 0, isTrusted: 0 }, As = Dr(Rl), vu = q({}, Rl, { view: 0, detail: 0 }), Im = Dr(vu), zf, Qn, wl, ho = q({}, vu, { screenX: 0, screenY: 0, clientX: 0, clientY: 0, pageX: 0, pageY: 0, ctrlKey: 0, shiftKey: 0, altKey: 0, metaKey: 0, getModifierState: Hf, button: 0, buttons: 0, relatedTarget: function(n) {
  ...
  } }), Uf = Dr(ho), Qm = q({}, ho, { dataTransfer: 0 }), hu = Dr(Qm), Af = q({}, vu, { relatedTarget: 0 }), js = Dr(Af), Wm = q({}, Rl, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }), Gm = Dr(Wm), Xm = q({}, Rl, { clipboardData: function(n) {
    return "clipboardData" in n ? n.clipboardData : window.clipboardData;
  } }), Qp = Dr(Xm), jf = q({}, Rl, { data: 0 }), Ff = Dr(jf), Wp = {
    Esc: "Escape",
    Spacebar: " ",
    Left: "ArrowLeft",
    Up: "ArrowUp",
  ...
  var Vf = q({}, vu, { key: function(n) {
  ...
  } }), Bf = Dr(Vf), Pf = q({}, ho, { pointerId: 0, width: 0, height: 0, pressure: 0, tangentialPressure: 0, tiltX: 0, tiltY: 0, twist: 0, pointerType: 0, isPrimary: 0 }), Xp = Dr(Pf), Fs = q({}, vu, { touches: 0, targetTouches: 0, changedTouches: 0, altKey: 0, metaKey: 0, ctrlKey: 0, shiftKey: 0, getModifierState: Hf }), Kp = Dr(Fs), kr = q({}, Rl, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }), pi = Dr(kr), Sn = q({}, ho, {
    deltaX: function(n) {
    ...
    deltaZ: 0,
    deltaMode: 0
  }), vi = Dr(Sn), $f = [9, 13, 27, 32], mu = Ae && "CompositionEvent" in window, mo = null;
  ...
  function qm(n, r) {
    if (yu) return n === "compositionend" || !mu && Jp(n, r) ? (n = Lf(), pu = Ms = fi = null, yu = !1, n) : null;
    switch (n) {
      case "paste":
        return null;
      case "keypress":
    ...
    io(function() {
      ...
      e: {
        ...
        if (j !== void 0) {
          ...
          0 < he.length && (j = new ue(j, de, null, l, V), P.push({ event: j, listeners: he }));
        }
      }
      if (!(r & 7)) {
        e: {
          if (j = n === "mouseover" || n === "pointerover", ue = n === "mouseout" || n === "pointerout", j && l !== xt && (de = l.relatedTarget || l.fromElement) && (Nl(de) || de[hi])) break e;
          if ((ue || j) && (j = V.window === V ? V : (j = V.ownerDocument) ? j.defaultView || j.parentWindow : window, ue ? (de = l.relatedTarget || l.toElement, ue = N, de = de ? Nl(de) : null, de !== null && (pn = Qe(de), de !== pn || de.tag !== 5 && de.tag !== 6) && (de = null)) : (ue = null, de = N), ue !== de)) {
            if (he = Uf, B = "onMouseLeave", w = "onMouseEnter", T = "mouse", (n === "pointerout" || n === "pointerover") && (he = Xp, B = "onPointerLeave", w = "onPointerEnter", T = "pointer"), pn = ue == null ? j : _a(ue), _ = de == null ? j : _a(de), j = new he(B, T + "leave", ue, l, V), j.target = pn, j.relatedTarget = _, B = null, Nl(V) === N && (he = new he(w, T + "enter", de, l, V), he.target = _, he.relatedTarget = pn, B = he), pn = B, ue && de) t: {
        ...
        e: {
          if (j = N ? _a(N) : window, ue = j.nodeName && j.nodeName.toLowerCase(), ue === "select" || ue === "input" && j.type === "file") var pe = Jm;
          ...
          De && De(n, j, N), n === "focusout" && (De = j._wrapperState) && De.controlled && j.type === "number" && Ue(j, "number", j.value);
        }
        switch (De = N ? _a(N) : window, n) {
          case "focusin":
            (nv(De) || De.contentEditable === "true") && (Su = De, Wf = N, Co = null);
            break;
          case "focusout":
            Co = Wf = Su = null;
            break;
        ...
        ze && (qp && l.locale !== "ko" && (yu || ze !== "onCompositionStart" ? ze === "onCompositionEnd" && yu && (ke = Lf()) : (fi = V, Ms = "value" in fi ? fi.value : fi.textContent, yu = !0)), De = To(N, ze), 0 < De.length && (ze = new Ff(ze, n, null, l, V), P.push({ event: ze, listeners: De }), ke ? ze.data = ke : (ke = ev(l), ke !== null && (ze.data = ke)))), (ke = yo ? tv(n, l) : qm(n, l)) && (N = To(N, "onBeforeInput"), 0 < N.length && (V = new Ff("onBeforeInput", "beforeinput", null, l, V), P.push({ event: V, listeners: N }), V.data = ke));
      }
      _l(P, r);
    });
  }
...
`).replace(ly, "");
    ...
    if (It) {
      ...
      if (r) {
        ...
        if (!Tv(n, r)) {
          ...
          r = Va(l.nextSibling);
          var o = Nr;
          r && Tv(n, r) ? td(o, l) : (n.flags = n.flags & -4097 | 2, It = !1, Nr = n);
        }
      } else {
        if (nd(n)) throw Error(k(418));
  ...
  var oy = lt.ReactCurrentBatchConfig;
  function Ll(n, r, l) {
  ...
  function zl(n) {
    ...
    function C(w, T, _, B) {
      var pe = _.type;
      return pe === $e ? V(w, T, _.props.children, B, _.key) : T !== null && (T.elementType === pe || typeof pe == "object" && pe !== null && pe.$$typeof === pt && Rv(pe) === T.type) ? (B = c(T, _.props), B.ref = Ll(w, T, _), B.return = w, B) : (B = as(_.type, _.key, _.props, null, w.mode, B), B.ref = Ll(w, T, _), B.return = w, B);
    }
    function N(w, T, _, B) {
    ...
    function P(w, T, _) {
      ...
      if (typeof T == "object" && T !== null) {
        ...
        if (At(T) || ge(T)) return T = Ri(T, w.mode, _, null), T.return = w, T;
        ac(w, T);
      }
      return null;
    }
    function j(w, T, _, B) {
      ...
      if (typeof _ == "object" && _ !== null) {
        ...
        if (At(_) || ge(_)) return pe !== null ? null : V(w, T, _, B, null);
        ac(w, _);
      }
      return null;
    }
    function ue(w, T, _, B, pe) {
      ...
      if (typeof B == "object" && B !== null) {
        switch (B.$$typeof) {
          ...
          case pt:
            var De = B._init;
            return ue(w, T, _, De(B._payload), pe);
        }
        if (At(B) || ge(B)) return w = w.get(_) || null, V(T, w, B, pe, null);
        ac(T, B);
      }
      return null;
    }
    function de(w, T, _, B) {
      for (var pe = null, De = null, ke = T, ze = T = 0, Pn = null; ke !== null && ze < _.length; ze++) {
        ke.index > ze ? (Pn = ke, ke = null) : Pn = ke.sibling;
        var gt = j(w, ke, _[ze], B);
        if (gt === null) {
          ke === null && (ke = Pn);
          break;
        }
        n && ke && gt.alternate === null && r(w, ke), T = d(gt, T, ze), De === null ? pe = gt : De.sibling = gt, De = gt, ke = Pn;
      }
      if (ze === _.length) return l(w, ke), It && Ml(w, ze), pe;
      if (ke === null) {
        for (; ze < _.length; ze++) ke = P(w, _[ze], B), ke !== null && (T = d(ke, T, ze), De === null ? pe = ke : De.sibling = ke, De = ke);
        return It && Ml(w, ze), pe;
      }
      for (ke = o(w, ke); ze < _.length; ze++) Pn = ue(ke, w, ze, _[ze], B), Pn !== null && (n && Pn.alternate !== null && ke.delete(Pn.key === null ? ze : Pn.key), T = d(Pn, T, ze), De === null ? pe = Pn : De.sibling = Pn, De = Pn);
    ...
    function he(w, T, _, B) {
      ...
      for (var De = pe = null, ke = T, ze = T = 0, Pn = null, gt = _.next(); ke !== null && !gt.done; ze++, gt = _.next()) {
        ke.index > ze ? (Pn = ke, ke = null) : Pn = ke.sibling;
        ...
        n && ke && ul.alternate === null && r(w, ke), T = d(ul, T, ze), De === null ? pe = ul : De.sibling = ul, De = ul, ke = Pn;
      }
      if (gt.done) return l(
        w,
        ke
      ...
      if (ke === null) {
        for (; !gt.done; ze++, gt = _.next()) gt = P(w, gt.value, B), gt !== null && (T = d(gt, T, ze), De === null ? pe = gt : De.sibling = gt, De = gt);
        return It && Ml(w, ze), pe;
      }
      for (ke = o(w, ke); !gt.done; ze++, gt = _.next()) gt = ue(ke, w, ze, gt.value, B), gt !== null && (n && gt.alternate !== null && ke.delete(gt.key === null ? ze : gt.key), T = d(gt, T, ze), De === null ? pe = gt : De.sibling = gt, De = gt);
            ...
            e: {
              for (var pe = _.key, De = T; De !== null; ) {
                if (De.key === pe) {
                  ...
                  } else if (De.elementType === pe || typeof pe == "object" && pe !== null && pe.$$typeof === pt && Rv(pe) === De.type) {
  ...
  function _o(n, r, l, o) {
    ...
    if (d !== null) {
      ...
      do {
        ...
        } else ue = { eventTime: ue, lane: j, tag: S.tag, payload: S.payload, callback: S.callback, next: null }, V === null ? (N = V = ue, C = P) : V = V.next = ue, h |= j;
        if (S = S.next, S === null) {
  ...
  var qe = lt.ReactCurrentDispatcher, mt = lt.ReactCurrentBatchConfig, Mt = 0, yt = null, xn = null, Vn = null, oc = !1, zo = !1, Fl = 0, A = 0;
  function vt() {
    throw Error(k(321));
  }
  function Ne(n, r) {
  ...
  function Zi(n, r, l, o, c, d) {
    ...
    if (qe.current = $l, r = xn !== null && xn.next !== null, Mt = 0, Vn = xn = yt = null, oc = !1, r) throw Error(k(300));
    return n;
  }
  function Oa() {
    var n = Fl !== 0;
  ...
  function Ji(n) {
    ...
    if (c !== null) {
      ...
      C === null ? h = o : C.next = S, ka(o, r.memoizedState) || (Tn = !0), r.memoizedState = o, r.baseState = h, r.baseQueue = C, l.lastRenderedState = o;
    }
  ...
  function Hl(n) {
    ...
    if (c !== null) {
      ...
      while (h !== c);
      ka(d, r.memoizedState) || (Tn = !0), r.memoizedState = d, r.baseQueue === null && (r.baseState = d), l.lastRenderedState = d;
    }
    return [d, o];
  }
  function sc() {
  ...
  function pd(n, r, l) {
    return Mt & 21 ? (ka(l, r) || (l = Ds(), yt.lanes |= l, Ka |= l, n.baseState = !0), r) : (n.baseState && (n.baseState = !1, Tn = !0), n.memoizedState = l);
  }
  function Fo(n, r) {
    var l = Dt;
    Dt = l !== 0 && 4 > l ? l : 4, n(!0);
...
` + d.stack;
  ...
  var Po = lt.ReactCurrentOwner, Tn = !1;
  function Gn(n, r, l, o) {
  ...
  function Ur(n, r, l, o, c) {
    l = l.render;
    var d = r.ref;
    return qt(r, c), o = Zi(n, r, l, o, d, c), l = Oa(), n !== null && !Tn ? (r.updateQueue = n.updateQueue, r.flags &= -2053, n.lanes &= ~c, pa(n, r, c)) : (It && l && tc(r), r.flags |= 1, Gn(n, r, o, c), r.child);
  }
  ...
  function Lv(n, r, l, o, c) {
    ...
    return d = Or(r, d), qt(r, c), l = Zi(n, r, l, o, d, c), o = Oa(), n !== null && !Tn ? (r.updateQueue = n.updateQueue, r.flags &= -2053, n.lanes &= ~c, pa(n, r, c)) : (It && o && tc(r), r.flags |= 1, Gn(n, r, l, c), r.child);
  }
  function zv(n, r, l, o, c) {
    ...
    if (qt(r, c), r.stateNode === null) da(n, r), bc(r, l, o), Bo(r, l, o, c), o = !0;
      ...
      h.state = j, _o(r, o, h, c), C = r.memoizedState, S !== o || j !== C || Nn.current || Wr ? (typeof V == "function" && (hd(r, l, V, o), C = r.memoizedState), (S = Wr || _v(r, l, S, o, j, C, N)) ? (P || typeof h.UNSAFE_componentWillMount != "function" && typeof h.componentWillMount != "function" || (typeof h.componentWillMount == "function" && h.componentWillMount(), typeof h.UNSAFE_componentWillMount == "function" && h.UNSAFE_componentWillMount()), typeof h.componentDidMount == "function" && (r.flags |= 4194308)) : (typeof h.componentDidMount == "function" && (r.flags |= 4194308), r.memoizedProps = o, r.memoizedState = C), h.props = o, h.state = C, h.context = N, o = S) : (typeof h.componentDidMount == "function" && (r.flags |= 4194308), o = !1);
    } else {
      h = r.stateNode, wv(n, r), S = r.memoizedProps, N = r.type === r.elementType ? S : Na(r.type, S), h.props = N, P = r.pendingProps, j = h.context, C = l.contextType, typeof C == "object" && C !== null ? C = fa(C) : (C = En(l) ? _r : an.current, C = Or(r, C));
  ...
  function Av(n, r, l, o, c, d, h) {
    ...
    return c.data === "$?" ? (r.flags |= 128, r.child = n.child, r = my.bind(null, n), c._reactRetry = r, null) : (n = d.treeContext, Mr = Va(c.nextSibling), Nr = r, It = !0, ca = null, n !== null && (Cn[sa++] = Ya, Cn[sa++] = Ia, Cn[sa++] = Yr, Ya = n.id, Ia = n.overflow, Yr = r), r = xd(r, o.children), r.flags |= 4096, r);
  }
  function Td(n, r, l) {
    n.lanes |= r;
    var o = n.alternate;
  ...
  va = function(n, r) {
    ...
    if (c !== o) {
      ...
      } else N !== "dangerouslySetInnerHTML" && N !== "children" && N !== "suppressContentEditableWarning" && N !== "suppressHydrationWarning" && N !== "autoFocus" && (we.hasOwnProperty(N) ? d || (d = []) : (d = d || []).push(N, null));
      for (N in o) {
        var C = o[N];
        ...
        else N === "dangerouslySetInnerHTML" ? (C = C ? C.__html : void 0, S = S ? S.__html : void 0, C != null && S !== C && (d = d || []).push(N, C)) : N === "children" ? typeof C != "string" && typeof C != "number" || (d = d || []).push(N, "" + C) : N !== "suppressContentEditableWarning" && N !== "suppressHydrationWarning" && (we.hasOwnProperty(N) ? (C != null && N === "onScroll" && Rt("scroll", n), d || S === C || (d = [])) : (d = d || []).push(N, C));
      }
      l && (d = d || []).push("style", l);
      var N = d;
  ...
  function Hv(n, r, l) {
    ...
    switch (nc(r), r.tag) {
      ...
      case 3:
        return o = r.stateNode, jl(), Vt(Nn), Vt(an), xe(), o.pendingContext && (o.context = o.pendingContext, o.pendingContext = null), (n === null || n.child === null) && (rc(r) ? r.flags |= 4 : n === null || n.memoizedState.isDehydrated && !(r.flags & 256) || (r.flags |= 1024, ca !== null && (Gl(ca), ca = null))), Rn(n, r), Bn(r), null;
      case 5:
        lc(r);
        var c = Al(Mo.current);
          ...
          if (n = Al(Qa.current), rc(r)) {
            ...
            e: {
              ...
              for (d in S) if (S.hasOwnProperty(d)) {
                var C = S[d];
                d === "style" ? ut(n, C) : d === "dangerouslySetInnerHTML" ? (C = C ? C.__html : void 0, C != null && gn(n, C)) : d === "children" ? typeof C == "string" ? (l !== "textarea" || C !== "") && W(n, C) : typeof C == "number" && W(n, "" + C) : d !== "suppressContentEditableWarning" && d !== "suppressHydrationWarning" && d !== "autoFocus" && (we.hasOwnProperty(d) ? C != null && d === "onScroll" && Rt("scroll", n) : C != null && Me(n, d, C, h));
              }
              switch (l) {
                case "input":
                  yn(n), ja(n, o, !1);
    ...
    for (Ol = { focusedElem: n, selectionRange: l }, Tl = !1, ce = r; ce !== null; ) if (r = ce, n = r.child, (r.subtreeFlags & 1028) !== 0 && n !== null) n.return = r, ce = n;
      ...
      try {
        ...
        if (r.flags & 1024) switch (r.tag) {
          ...
          case 1:
            if (de !== null) {
              var he = de.memoizedProps, pn = de.memoizedState, w = r.stateNode, T = w.getSnapshotBeforeUpdate(r.elementType === r.type ? he : Na(r.type, he), pn);
  ...
  function wd(n, r) {
    ...
    switch (n.tag) {
      ...
      case 15:
        ...
        break;
      case 1:
        Ma(r, n), Ar(n), o & 512 && l !== null && Nu(l, l.return);
        break;
      case 5:
        if (Ma(r, n), Ar(n), o & 512 && l !== null && Nu(l, l.return), n.flags & 32) {
          var c = n.stateNode;
          try {
            W(c, "");
          } catch (he) {
        ...
        if (o & 4 && (c = n.stateNode, c != null)) {
          ...
          if (n.updateQueue = null, C !== null) try {
            ...
            for (h = 0; h < C.length; h += 2) {
              var V = C[h], P = C[h + 1];
              V === "style" ? ut(c, P) : V === "dangerouslySetInnerHTML" ? gn(c, P) : V === "children" ? W(c, P) : Me(c, V, P, N);
            }
            switch (S) {
              case "input":
                Ra(c, d);
      ...
      case 6:
        ...
        break;
      case 3:
        if (Ma(r, n), Ar(n), o & 4 && l !== null && l.memoizedState.isDehydrated) try {
          Bi(r.containerInfo);
        } catch (he) {
          Qt(n, n.return, he);
        }
      ...
      case 4:
        ...
        break;
      case 13:
        Ma(r, n), Ar(n), c = n.child, c.flags & 8192 && (d = c.memoizedState !== null, c.stateNode.isHidden = d, !d || c.alternate !== null && c.alternate.memoizedState !== null || (kd = We())), o & 4 && $v(n);
        break;
      case 22:
        if (V = l !== null && l.memoizedState !== null, n.mode & 1 ? (or = (N = or) || V, Ma(r, n), or = N) : Ma(r, n), Ar(n), o & 8192) {
  ...
  var fy = Math.ceil, tl = lt.ReactCurrentDispatcher, Ql = lt.ReactCurrentOwner, Xn = lt.ReactCurrentBatchConfig, ct = 0, Ln = null, wn = null, Kn = 0, Gr = 0, Mu = oa(0), dn = 0, Jo = null, Ka = 0, Lu = 0, Lc = 0, es = null, jr = null, kd = 0, zu = 1 / 0, Xr = null, Uu = !1, Wl = null, nl = null, zc = !1, xi = null, ts = 0, rl = 0, Au = null, ns = -1, sr = 0;
  function bn() {
    return ct & 6 ? We() : ns !== -1 ? ns : ns = We();
  }
  function qa(n) {
    return n.mode & 1 ? ct & 2 && Kn !== 0 ? Kn & -Kn : oy.transition !== null ? (sr === 0 && (sr = Ds()), sr) : (n = Dt, n !== 0 || (n = window.event, n = n === void 0 ? 16 : Ns(n.type)), n) : 1;
  }
  function mr(n, r, l, o) {
    if (50 < rl) throw rl = 0, Au = null, Error(k(185));
    Cl(n, l, o), (!(ct & 2) || n !== Ln) && (n === Ln && (!(ct & 2) && (Lu |= l), dn === 4 && La(n, Kn)), Fr(n, o), l === 1 && ct === 0 && !(r.mode & 1) && (zu = We() + 500, bu && $a()));
  }
  function Fr(n, r) {
  ...
  function Iv(n, r) {
    do {
      ...
      try {
        ...
        if (Mt = 0, Vn = xn = yt = null, zo = !1, Fl = 0, Ql.current = null, l === null || l.return === null) {
          dn = 1, Jo = r, wn = null;
          break;
        }
        e: {
  ...
  function Md() {
    (dn === 0 || dn === 3 || dn === 2) && (dn = 4), Ln === null || !(Ka & 268435455) && !(Lu & 268435455) || La(Ln, Kn);
  }
  function Ac(n, r) {
    var l = ct;
    ct |= 2;
  ...
  function Wv() {
    for (; wn !== null && !ui(); ) Gv(wn);
  }
  function Gv(n) {
    var r = Jv(n.alternate, n, Gr);
    n.memoizedProps = n.pendingProps, r === null ? Xv(n) : wn = r, Ql.current = null;
  }
  function Xv(n) {
    var r = n;
    do {
  ...
  function vy(n, r, l, o) {
    ...
    if ($m(n, d), n === Ln && (wn = Ln = null, Kn = 0), !(l.subtreeFlags & 2064) && !(l.flags & 2064) || zc || (zc = !0, eh(uo, function() {
      ...
      Dt = 1;
      var S = ct;
      ct |= 4, Ql.current = null, Bv(n, l), wd(l, n), gu(Ol), Tl = !!Ro, Ol = Ro = null, n.current = l, cy(l), oi(), ct = S, Dt = h, Xn.transition = d;
    } else n.current = l;
    ...
    if (xi !== null) {
      ...
      try {
        if (Xn.transition = null, Dt = 16 > n ? 16 : n, xi === null) var o = !1;
          ...
          if (ct = c, $a(), ba && typeof ba.onPostCommitFiberRoot == "function") try {
  ...
  function Kv(n, r, l) {
    r = Yl(l, r), r = Nv(n, r, 1), n = qi(n, r, 1), r = bn(), n !== null && (Cl(n, 1, r), Fr(n, r));
  }
  function Qt(n, r, l) {
    if (n.tag === 3) Kv(n, n, l);
    else for (; r !== null; ) {
  ...
  Jv = function(n, r, l) {
    ...
    else Tn = !1, It && r.flags & 1048576 && xv(r, yi, r.index);
    switch (r.lanes = 0, r.tag) {
      ...
      case 16:
        o = r.elementType;
        e: {
          switch (da(n, r), n = r.pendingProps, c = o._init, o = c(o._payload), r.type = o, c = r.tag = gy(o), n = Na(o, n), c) {
            case 0:
              r = Lv(null, r, o, n, l);
              break e;
            case 1:
        ...
        return r;
      case 0:
        return o = r.type, c = r.pendingProps, c = r.elementType === o ? c : Na(o, c), Lv(n, r, o, c, l);
      case 1:
        return o = r.type, c = r.pendingProps, c = r.elementType === o ? c : Na(o, c), zv(n, r, o, c, l);
      case 3:
        e: {
          ...
          if (o = h.element, d.isDehydrated) if (d = { element: o, isDehydrated: !1, cache: h.cache, pendingSuspenseBoundaries: h.pendingSuspenseBoundaries, transitions: h.transitions }, r.updateQueue.baseState = d, r.memoizedState = d, r.flags & 256) {
            ...
            break e;
          } else for (Mr = Va(r.stateNode.containerInfo.firstChild), Nr = r, It = !0, ca = null, l = ne(r, null, o, l), r.child = l; l; ) l.flags = l.flags & -3 | 4096, l = l.sibling;
          else {
            if (Ki(), o === c) {
              r = pa(n, r, l);
              break e;
      ...
      case 11:
        return o = r.type, c = r.pendingProps, c = r.elementType === o ? c : Na(o, c), Ur(n, r, o, c, l);
      case 7:
      ...
      case 14:
        return o = r.type, c = Na(o, r.pendingProps), c = Na(o.type, c), Il(n, r, o, c, l);
      case 15:
        return Ie(n, r, r.type, r.pendingProps, l);
      case 17:
        return o = r.type, c = r.pendingProps, c = r.elementType === o ? c : Na(o, c), da(n, r), r.tag = 1, En(o) ? (n = !0, Hn(r)) : n = !1, qt(r, l), bc(r, o, c), Bo(r, o, c, l), Yo(null, r, o, !0, n, l);
      case 19:
        return Wa(n, r, l);
      case 22:
        return $o(n, r, l);
  ...
  function as(n, r, l, o, c, d) {
    ...
    if (o = n, typeof n == "function") Ld(n) && (h = 1);
      ...
      case G:
        return n = ha(13, l, r, c), n.elementType = G, n.lanes = d, n;
      case ye:
...
function ek() {
  return rT || (rT = 1, process.env.NODE_ENV !== "production" && function() {
    typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(new Error());
    var H = Cf, K = iT(), k = H.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, it = !1;
    function we(e) {
      it = e;
    }
    function Ve(e) {
    ...
    var J = 0, Z = 1, Oe = 2, Y = 3, ee = 4, I = 5, fe = 6, Te = 7, be = 8, tt = 9, Je = 10, Me = 11, lt = 12, Fe = 13, Tt = 14, $e = 15, ln = 16, Ut = 17, en = 18, Wt = 19, Q = 21, G = 22, ye = 23, Xe = 24, pt = 25, Ft = !0, X = !1, ge = !1, q = !1, Ze = !1, nt = !0, Yn = !0, un = !0, ta = !0, hn = /* @__PURE__ */ new Set(), mn = {}, kn = {};
    function ir(e, t) {
    ...
    var _t = 0, Ot = 1, jn = 2, Nt = 3, tn = 4, nn = 5, Fn = 6, gn = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", W = gn + "\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040", ie = new RegExp("^[" + gn + "][" + W + "]*$"), Be = {}, Ge = {};
    function ut(e) {
      return cr.call(Ge, e) ? !0 : cr.call(Be, e) ? !1 : ie.test(e) ? (Ge[e] = !0, !0) : (Be[e] = !0, g("Invalid attribute name: `%s`", e), !1);
    }
    function ht(e, t, a) {
    ...
    var Ke = Object.assign, si = 0, lo, uo, Bp, xf, oo, ba, Pp;
    function ra() {
    }
...
Check the render method of \`` + e + "`." : "";
    ...
    function Ff(e, t) {
      var a = e;
      Nf("textarea", t), t.value !== void 0 && t.defaultValue !== void 0 && !Qp && (g("%s contains a textarea with both value and defaultValue props. Textarea elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled textarea and remove one of these props. More info: https://reactjs.org/link/controlled-components", aa() || "A component"), Qp = !0);
      var i = t.value;
      if (i == null) {
    ...
    var Eo = {
      ...
      "aria-rowspan": 0,
      "aria-setsize": 0
    }, gu = {}, ry = new RegExp("^(aria)-[" + W + "]*$"), Su = new RegExp("^(aria)[A-Z][" + W + "]*$");
    function Wf(e, t) {
      {
    ...
    {
      var Wn = {}, Kf = /^on./, $s = /^on[^A-Z]/, fv = new RegExp("^(aria)-[" + W + "]*$"), dv = new RegExp("^(aria)[A-Z][" + W + "]*$");
      Dl = function(e, t, a, i) {
    ...
    if (typeof window < "u" && typeof window.dispatchEvent == "function" && typeof document < "u" && typeof document.createEvent == "function") {
      ...
      qs = function(t, a, i, u, s, f, p, v, m) {
        ...
        var Se, dt = !1, at = !1;
        function b(D) {
          if (Se = D.error, dt = !0, Se === null && D.colno === 0 && D.lineno === 0 && (at = !0), D.defaultPrevented && Se != null && typeof Se == "object")
            try {
    ...
    var td = K.unstable_scheduleCallback, Tv = K.unstable_cancelCallback, nd = K.unstable_shouldYield, rd = K.unstable_requestPaint, Mn = K.unstable_now, rc = K.unstable_getCurrentPriorityLevel, ko = K.unstable_ImmediatePriority, Ki = K.unstable_UserBlockingPriority, gi = K.unstable_NormalPriority, oy = K.unstable_LowPriority, Ll = K.unstable_IdlePriority, ac = K.unstable_yieldValue, Rv = K.unstable_setDisableYieldValue, zl = null, sn = null, ne = null, Ir = !1, Lr = typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u";
    function Du(e) {
      if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ > "u")
        return !1;
    ...
    var pr = Ne, Wa = Oa, da = cn, pa = Pl, Qo = vt;
    function va() {
      return Qo;
    }
    function Rn(e) {
    ...
    var Mc = !1, qo = [], Ci = null, Ga = null, Xa = null, fn = /* @__PURE__ */ new Map(), vr = /* @__PURE__ */ new Map(), hr = [], Pv = [
      "mousedown",
      "mouseup",
      "touchcancel",
      "touchend",
    ...
    function tl(e, t) {
      e.blockedOn === t && (e.blockedOn = null, Mc || (Mc = !0, K.unstable_scheduleCallback(K.unstable_NormalPriority, fy)));
    }
    function Ql(e) {
      if (qo.length > 0) {
        tl(qo[0], e);
    ...
    var hy = Ke({}, mr, {
      ...
      deltaMode: 0
    }), gy = sr(Ld), al = [9, 13, 27, 32], as = 229, Ri = yn && "CompositionEvent" in window, il = null;
    yn && "documentMode" in document && (il = document.documentMode);
    var zd = yn && "TextEvent" in window && !il, jc = yn && (!Ri || il && il > 8 && il <= 11), th = 32, Fc = String.fromCharCode(th);
    function Sy() {
    ...
    function pn(e, t, a, i, u, s, f) {
      ...
      if (r(p) ? v = d : is(p) ? h ? v = de : (v = P, m = V) : j(p) && (v = ue), v) {
        var y = v(t, a);
        if (y) {
          ih(e, y, i, u);
          return;
    ...
    function T(e, t, a, i, u, s, f) {
      ...
      if (!(!v && !p)) {
        ...
        if (v) {
          ...
          x = null, O = a;
        if (x !== O) {
          var re = _d, Re = "onMouseLeave", Se = "onMouseEnter", dt = "mouse";
          (t === "pointerout" || t === "pointerover") && (re = Zv, Re = "onPointerLeave", Se = "onPointerEnter", dt = "pointer");
          var at = x == null ? y : Xc(x), b = O == null ? y : Xc(O), z = new re(Re, dt + "leave", x, i, u);
          z.target = at, z.relatedTarget = b;
          var D = null, $ = ss(u);
          if ($ === a) {
            var se = new re(Se, dt + "enter", O, i, u);
            se.target = b, se.relatedTarget = at, D = se;
          }
          DT(e, z, D, x, O);
        }
      }
    ...
    yn && (E0 = document.createElement("div").style, "AnimationEvent" in window || (delete Ic.animationend.animation, delete Ic.animationiteration.animation, delete Ic.animationstart.animation), "TransitionEvent" in window || delete Ic.transitionend.transition);
    function oh(e) {
      if (wy[e])
        return wy[e];
      if (!Ic[e])
    ...
    var ma = !1, $d = "dangerouslySetInnerHTML", fh = "suppressContentEditableWarning", Hu = "suppressHydrationWarning", M0 = "autoFocus", us = "children", os = "style", dh = "__html", _y, ph, Yd, L0, vh, z0, U0;
    _y = {
...
`).replace(OT, "");
    ...
    function MT(e, t, a, i, u) {
      for (var s in i)
        if (i.hasOwnProperty(s)) {
          ...
          else s === fh || s === Hu || s === M0 || (mn.hasOwnProperty(s) ? f != null && (typeof f != "function" && vh(s, f), s === "onScroll" && Jt("scroll", t)) : f != null && ii(t, s, f, u));
        }
    }
    function LT(e, t, a, i) {
    ...
    function jT(e, t, a, i, u) {
      ...
      for (v in f)
        if (!(p.hasOwnProperty(v) || !f.hasOwnProperty(v) || f[v] == null))
          ...
          } else v === $d || v === us || v === fh || v === Hu || v === M0 || (mn.hasOwnProperty(v) ? s || (s = []) : (s = s || []).push(v, null));
      for (v in p) {
        ...
        if (!(!p.hasOwnProperty(v) || x === O || x == null && O == null))
          ...
          } else v === us ? (typeof x == "string" || typeof x == "number") && (s = s || []).push(v, "" + x) : v === fh || v === Hu || (mn.hasOwnProperty(v) ? (x != null && (typeof x != "function" && vh(v, x), v === "onScroll" && Jt("scroll", e)), !s && O !== x && (s = [])) : (s = s || []).push(v, x));
      }
    ...
    function VT(e, t, a, i, u, s, f) {
      ...
      for (var M in a)
        if (a.hasOwnProperty(M)) {
          ...
          typeof p == "boolean") {
            var re = void 0, Re = xt(M);
            if (a[Hu] !== !0) {
              if (!(M === fh || M === Hu || // Controlled attributes are not validated
              // TODO: Only ignore them on controlled tags.
              M === "value" || M === "checked" || M === "selected")) {
                if (M === $d) {
                  var Se = e.innerHTML, dt = L ? L[dh] : void 0;
                  if (dt != null) {
                    var at = U0(e, dt);
                    at !== Se && Yd(M, Se, at);
                  }
                  ...
                  if (v.delete(M), z0) {
                    var b = ey(L);
                    re = e.getAttribute("style"), b !== re && Yd(M, re, b);
                  }
                } else if (p && !Ze)
                  v.delete(M.toLowerCase()), re = io(e, M, L), L !== re && Yd(M, re, L);
                else if (!ht(M, Re, p) && !_n(M, L, Re, p)) {
                  var z = !1;
                  if (Re !== null)
                    v.delete(Re.attributeName), re = fu(e, M, L, Re);
                  else {
                    var D = i;
                    if (D === di && (D = Bf(t)), D === di)
    ...
    function yR(e, t) {
      e.nodeType === Sn ? Hy(e.parentNode, t) : e.nodeType === kr && Hy(e, t), Ql(e);
    }
    function gR(e) {
      e = e;
      var t = e.style;
    ...
    var Zc = [], Jc = 0, Oh = null, Nh = 0, Za = [], Ja = 0, cs = null, tu = 1, nu = "";
    function r1(e) {
    ...
    function J0(e, t, a) {
      ...
      if (v > 30) {
        var m = s - s % 5, y = (1 << m) - 1, R = (f & y).toString(32), x = f >> m, O = s - m, M = Mh(t) + O, L = p << O, re = L | x, Re = R + u;
        tu = 1 << M | re, nu = Re;
      } else {
        var Se = p << s, dt = Se | f, at = u;
        tu = 1 << v | dt, nu = at;
      }
    }
    function Ky(e) {
    ...
    function Zy(e, t) {
      {
        ...
        switch (e.tag) {
          ...
          case I: {
            ...
            switch (t.tag) {
              case I: {
                var v = t.type, m = t.pendingProps, y = (e.mode & qe) !== xe;
                WR(
                  s,
                  f,
                  p,
              ...
              case fe: {
                var R = t.pendingProps, x = (e.mode & qe) !== xe;
                GR(
                  s,
                  f,
                  p,
    ...
    function Jy(e) {
      return (e.mode & qe) !== xe && (e.flags & Ee) === Ce;
    }
    function eg(e) {
    ...
    function v1(e) {
      ...
      if (i) {
        ...
        if (u !== null)
          switch (u.tag) {
            case Y: {
              var s = u.stateNode.containerInfo, f = (u.mode & qe) !== xe;
              FR(
                s,
                t,
                a,
            ...
            case I: {
              var p = u.type, v = u.memoizedProps, m = u.stateNode, y = (u.mode & qe) !== xe;
              HR(
                p,
                v,
                m,
...
Learn more about this warning here: https://reactjs.org/link/legacy-context`, u);
    ...
    function ip(e, t, a) {
      ...
      if (i !== null && typeof i != "function" && typeof i != "object") {
        if ((e.mode & Mt || nt) && // We warn in ReactElement.js if owner and self are equal for string refs
...
See https://reactjs.org/link/refs-must-have-owner for more information.`);
    ...
    function fE(e) {
      ...
      function L(b, z, D, $) {
        ...
        if (St === null) {
          for (; Et < D.length; Et++) {
            var Aa = R(b, D[Et], $);
            Aa !== null && (zn = s(Aa, zn, Et), zt === null ? He = Aa : zt.sibling = Aa, zt = Aa);
          }
          if (gr()) {
            var Jr = Et;
            fs(b, Jr);
      ...
      function re(b, z, D, $) {
        ...
        for (var zn = null, Et = null, Dn = z, Pr = 0, wr = 0, Aa = null, Jr = St.next(); Dn !== null && !Jr.done; wr++, Jr = St.next()) {
          Dn.index > wr ? (Aa = Dn, Dn = null) : Aa = Dn.sibling;
          var ea = x(b, Dn, Jr.value, $);
          if (ea === null) {
            Dn === null && (Dn = Aa);
            break;
          }
          e && Dn && ea.alternate === null && t(b, Dn), Pr = s(ea, Pr, wr), Et === null ? zn = ea : Et.sibling = ea, Et = ea, Dn = Aa;
        }
        if (Jr.done) {
          if (a(b, Dn), gr()) {
            var $r = wr;
        ...
        for (var jp = i(b, Dn); !Jr.done; wr++, Jr = St.next()) {
          ...
          yl !== null && (e && yl.alternate !== null && jp.delete(yl.key === null ? wr : yl.key), Pr = s(yl, Pr, wr), Et === null ? zn = yl : Et.sibling = yl, Et = yl);
        }
    ...
    function b1(e, t, a) {
      ...
      for (i !== null && (i.return = e); i !== null; ) {
        ...
        if (s !== null) {
          ...
          var M = O.alternate;
          M !== null && (M.lanes = Ie(M.lanes, a)), dg(O, a, e), u = i.sibling;
        } else
          u = i.child;
        if (u !== null)
          u.return = i;
    ...
    function Ih(e, t, a, i) {
      ...
      if (s !== null) {
        var O = u.baseState, M = A, L = null, re = null, Re = null, Se = s;
        do {
          var dt = Se.lane, at = Se.eventTime;
          if (Il(i, dt)) {
            if (Re !== null) {
              var z = {
                eventTime: at,
            ...
            Re === null ? (re = Re = b, L = O) : Re = Re.next = b, M = Ie(M, dt);
          }
    ...
    wg = /* @__PURE__ */ new Set();
    var ys = A, Lt = null, Jn = null, er = null, Kh = !1, cp = !1, fp = 0, j1 = 0, F1 = 25, U = null, ti = null, Gu = -1, bg = !1;
    function wt() {
      {
        var e = U;
...
Incoming: %s`, U, "[" + t.join(", ") + "]", "[" + e.join(", ") + "]");
    ...
    function cf(e, t, a, i, u, s) {
      ys = s, Lt = t, ti = e !== null ? e._debugHookTypes : null, Gu = -1, bg = e !== null && e.type !== t.type, t.memoizedState = null, t.updateQueue = null, t.lanes = A, e !== null && e.memoizedState !== null ? oe.current = WE : ti !== null ? oe.current = QE : oe.current = IE;
      var f = a(i, u);
      if (cp) {
        var p = 0;
        do {
      ...
      (e.mode & qe) !== xe && g("Internal React error: Expected static flag was missing. Please notify the React team."), Kh = !1, v)
    ...
    function DE() {
      ...
      ys = A, Lt = null, Jn = null, er = null, ti = null, Gu = -1, U = null, VE = !1, cp = !1, fp = 0;
    }
    function fl() {
      var e = {
        memoizedState: null,
      ...
      if (f !== null) {
        ...
        do {
          ...
          if (Il(ys, re)) {
            ...
            M === null ? (O = M = Re, x = R) : M = M.next = Re, Lt.lanes = Ie(Lt.lanes, re), Mp(re);
          }
          L = L.next;
        } while (L !== null && L !== y);
    ...
    function tm(e, t) {
      return (Lt.mode & yt) !== xe ? pp($a | _r | ec, Sr, e, t) : pp(_r | ec, Sr, e, t);
    }
    function vp(e, t) {
      return em(_r, Sr, e, t);
    }
    ...
    function jg(e, t) {
      var a = st;
      return a |= mi, (Lt.mode & yt) !== xe && (a |= Qi), pp(a, Zn, e, t);
    }
    function rm(e, t) {
      return em(st, Zn, e, t);
    }
    ...
    function Fg(e, t, a) {
      ...
      return u |= mi, (Lt.mode & yt) !== xe && (u |= Qi), pp(u, Zn, zE.bind(null, t, e), i);
    }
    function am(e, t, a) {
      typeof t != "function" && g("Expected useImperativeHandle() second argument to be a function that creates a handle. Instead received: %s.", t !== null ? typeof t : "null");
      var i = a != null ? a.concat([e]) : null;
      return em(st, Zn, zE.bind(null, t, e), i);
    }
    function V1(e, t) {
    }
    var im = V1;
    ...
    }, IE = null, QE = null, WE = null, GE = null, dl = null, _i = null, cm = null;
    {
      ...
      IE = {
        ...
        useSyncExternalStore: function(e, t, a) {
          return U = "useSyncExternalStore", te(), Mg(e, t, a);
        },
        useId: function() {
          return U = "useId", te(), $g();
        },
    ...
    var Xu = K.unstable_now, XE = 0, fm = -1, hp = -1, dm = -1, Ig = !1, pm = !1;
    function KE() {
      return Ig;
    }
    function I1() {
    ...
    function G1(e, t, a) {
      var i = e.stateNode;
      {
        ...
        // this one.
        (e.mode & Mt) === xe && (mp.add(t), g(`%s uses the legacy childContextTypes API which is no longer supported and will be removed in the next major release. Use React.createContext() instead
...
.Learn more about this warning here: https://reactjs.org/link/legacy-context`, u)), t.contextTypes && !mp.has(t) && // Strict Mode has its own warning for legacy context, so we can skip
        // this one.
        (e.mode & Mt) === xe && (mp.add(t), g(`%s uses the legacy contextTypes API which is no longer supported and will be removed in the next major release. Use React.createContext() with static contextType instead.
      ...
      rC(e, y);
      {
        ...
        if (typeof t.getDerivedStateFromProps == "function" || typeof y.getSnapshotBeforeUpdate == "function") {
          ...
          if (typeof y.componentWillMount == "function" && y.componentWillMount.__suppressDeprecationWarning !== !0 ? O = "componentWillMount" : typeof y.UNSAFE_componentWillMount == "function" && (O = "UNSAFE_componentWillMount"), typeof y.componentWillReceiveProps == "function" && y.componentWillReceiveProps.__suppressDeprecationWarning !== !0 ? M = "componentWillReceiveProps" : typeof y.UNSAFE_componentWillReceiveProps == "function" && (M = "UNSAFE_componentWillReceiveProps"), typeof y.componentWillUpdate == "function" && y.componentWillUpdate.__suppressDeprecationWarning !== !0 ? L = "componentWillUpdate" : typeof y.UNSAFE_componentWillUpdate == "function" && (L = "UNSAFE_componentWillUpdate"), O !== null || M !== null || L !== null) {
            var re = kt(t) || "Component", Re = typeof t.getDerivedStateFromProps == "function" ? "getDerivedStateFromProps()" : "getSnapshotBeforeUpdate()";
...
https://reactjs.org/link/unsafe-component-lifecycles`, re, Re, O !== null ? `
  ...
  ` + L : ""));
    ...
    function q1(e, t, a, i, u) {
      ...
      if (Ih(t, i, s, u), re = t.memoizedState, f === v && L === re && !bh() && !Qh() && !ge)
      ...
      ge;
      return Re ? (!M && (typeof s.UNSAFE_componentWillUpdate == "function" || typeof s.componentWillUpdate == "function") && (typeof s.componentWillUpdate == "function" && s.componentWillUpdate(i, re, R), typeof s.UNSAFE_componentWillUpdate == "function" && s.UNSAFE_componentWillUpdate(i, re, R)), typeof s.componentDidUpdate == "function" && (t.flags |= st), typeof s.getSnapshotBeforeUpdate == "function" && (t.flags |= Nn)) : (typeof s.componentDidUpdate == "function" && (f !== e.memoizedProps || L !== e.memoizedState) && (t.flags |= st), typeof s.getSnapshotBeforeUpdate == "function" && (f !== e.memoizedProps || L !== e.memoizedState) && (t.flags |= Nn), t.memoizedProps = i, t.memoizedState = re), s.props = i, s.state = re, s.context = R, Re;
    }
    function gs(e, t) {
      return {
        value: e,
...
` + ("" + m);
    ...
    function nw(e, t, a, i, u) {
      if (a.flags |= Do, Lr && Lp(e, u), i !== null && typeof i == "object" && typeof i.then == "function") {
        ...
        var v = oC(t);
        if (v !== null) {
          (v.flags & Hn) === Ce && (v.flags |= lr), sC(v, t, a, e, u), ng(gs(i, a));
          return;
        }
      }
      i = gs(i, a), Ub(i);
      ...
      do {
        switch (m.tag) {
          ...
          case Z:
            ...
            if ((m.flags & Ee) === Ce && (typeof M.getDerivedStateFromError == "function" || L !== null && typeof L.componentDidCatch == "function" && !ox(L))) {
              m.flags |= Hn;
              var re = Po(u);
    ...
    var yp = k.ReactCurrentOwner, Ni = !1, fS, gp, dS, pS, vS, Ss, hS, mm, Sp;
    ...
    function cC(e, t, a, i, u) {
      ...
      return Wr(), e !== null && !Ni ? (bE(e, t, u), au(e, t, u)) : (gr() && m && Ky(t), t.flags |= _a, Kr(e, t, v, u), t.child);
    }
    ...
    function dC(e, t, a, i, u) {
      ...
      if (e !== null) {
        ...
        t.type === e.type)
          if (Ni = !1, t.pendingProps = i = y, RS(e, u))
            (e.flags & Js) !== Ce && (Ni = !0);
...
Check the render method of \`` + i + "`.");
    ...
    function gC(e, t, a) {
      ...
      if (f || hw(u, e) ? (s = !0, t.flags &= ~Ee) : (e === null || e.memoizedState !== null) && (u = z1(u, wE)), u = lf(u), Wu(t, u), e === null) {
        ...
        if (s) {
          var L = i.fallback, re = i.children, Re = Sw(e, t, re, L, a), Se = t.child, dt = e.child.memoizedState;
          return Se.memoizedState = dt === null ? ES(a) : vw(dt, a), Se.childLanes = mw(e, a), t.memoizedState = SS, Re;
        } else {
          var at = i.children, b = gw(e, t, at, a);
    ...
    function yw(e, t, a, i) {
      ...
      return (u & qe) === xe && s !== null ? (p = s, p.childLanes = A, p.pendingProps = f, e.mode & mt && (p.actualDuration = 0, p.actualStartTime = -1, p.selfBaseDuration = 0, p.treeBaseDuration = 0), v = to(a, u, i, null)) : (p = xS(f, u), v = to(a, u, i, null)), p.return = e, v.return = e, p.sibling = v, e.child = p, v;
    }
    function xS(e, t, a) {
    ...
    function gw(e, t, a, i) {
      ...
      if ((t.mode & qe) === xe && (f.lanes = i), f.return = t, f.sibling = null, s !== null) {
        var p = t.deletions;
    ...
    function Sw(e, t, a, i, u) {
      ...
      if (
        ...
        (s & qe) === xe && // Make sure we're on the second pass, i.e. the primary child fragment was
    ...
    function Ew(e, t, a, i, u) {
      ...
      return v.flags |= Kt, p.return = t, v.return = t, p.sibling = v, t.child = p, (t.mode & qe) !== xe && tf(t, e.child, null, u), v;
    }
    function Cw(e, t, a) {
      return (e.mode & qe) === xe ? (g("Cannot hydrate Suspense in legacy mode. Switch from ReactDOM.hydrate(element, container) to ReactDOMClient.hydrateRoot(container, <App />).render(element) or remove the Suspense components from the server rendered components."), e.lanes = Ne) : Vy(t) ? e.lanes = ur : e.lanes = zr, null;
    }
    function xw(e, t, a, i, u, s, f) {
      if (a)
        ...
        if (Ni || O) {
          ...
          var dt = i.children, at = CS(t, dt);
          return at.flags |= Or, at;
        }
      }
    }
    function EC(e, t, a) {
    ...
    function gm(e, t) {
      (t.mode & qe) === xe && e !== null && (e.alternate = null, t.alternate = null, t.flags |= Kt);
    }
    function au(e, t, a) {
    ...
    function wC(e, t, a) {
      ...
      if (e !== null) {
        ...
        t.type !== e.type)
          ...
          (t.flags & Ee) === Ce)
            return Ni = !1, Mw(e, t, a);
          (e.flags & Js) !== Ce ? Ni = !0 : Ni = !1;
        }
      } else if (Ni = !1, gr() && r1(t)) {
        var f = t.index, p = a1();
        J0(t, p, f);
      }
      switch (t.lanes = A, t.tag) {
        ...
        case tt:
          return Ow(e, t, a);
        case Tt: {
          var Se = t.type, dt = t.pendingProps, at = Oi(Se, dt);
          if (t.type !== t.elementType) {
            var b = Se.propTypes;
            b && wi(
              b,
          ...
          return at = Oi(Se.type, at), fC(e, t, Se, at, a);
        }
        case $e:
    ...
    function Lw(e, t, a) {
      if (y1() && (t.mode & qe) !== xe && (t.flags & Ee) === Ce)
        return lE(t), ef(), t.flags |= lr | Do | Hn, !1;
      var i = Lh(t);
      if (a !== null && a.dehydrated !== null)
        if (e === null) {
          ...
          if (ef(), (t.flags & Ee) === Ce && (t.memoizedState = null), t.flags |= st, Er(t), (t.mode & mt) !== xe) {
            var f = a !== null;
            if (f) {
              var p = t.child;
    ...
    function OC(e, t, a) {
      ...
      switch (qy(t), t.tag) {
        ...
        case Fe: {
          ...
          var at = Se !== null, b = e !== null && e.memoizedState !== null;
          if (at !== b && at) {
            var z = t.child;
            if (z.flags |= En, (t.mode & qe) !== xe) {
              var D = e === null && (t.memoizedProps.unstable_avoidThisFallback !== !0 || !0);
              D || Cg(ki.current, wE) ? zb() : $S();
            }
          }
          var $ = t.updateQueue;
          if ($ !== null && (t.flags |= st), Er(t), (t.mode & mt) !== xe && at) {
            var se = t.child;
        ...
        case Wt: {
          ...
          if (He === null)
            return Er(t), null;
          var zt = (t.flags & Ee) !== Ce, St = He.rendering;
          if (St === null)
            if (zt)
              Cp(He, !1);
            else {
              var zn = Ab() && (e === null || (e.flags & Ee) === Ce);
              if (!zn)
                for (var Et = t.child; Et !== null; ) {
                  ...
                  if (Dn !== null) {
                    ...
                    return Pr !== null && (t.updateQueue = Pr, t.flags |= st), t.subtreeFlags = Ce, R1(t, a), Wu(t, xg(ki.current, op)), t.child;
                  }
                  Et = Et.sibling;
                }
            ...
            if (!zt) {
              ...
              if (wr !== null) {
                ...
                if (Aa !== null && (t.updateQueue = Aa, t.flags |= st), Cp(He, !0), He.tail === null && He.tailMode === "hidden" && !St.alternate && !gr())
                  return Er(t), null;
        ...
        case ye: {
          ...
          return !Ef || (t.mode & qe) === xe ? Er(t) : Ur(ml, zr) && (Er(t), t.subtreeFlags & (Kt | st) && (t.flags |= En)), null;
        }
        case Xe:
          return null;
        case pt:
    ...
    function zw(e, t, a) {
      switch (qy(t), t.tag) {
        case Z: {
          ...
          sl(i) && Dh(t);
          var u = t.flags;
          return u & Hn ? (t.flags = u & ~Hn | Ee, (t.mode & mt) !== xe && Xg(t), t) : null;
        }
        case Y: {
          t.stateNode, af(t), Wy(t), Rg();
          var s = t.flags;
          return (s & Hn) !== Ce && (s & Ee) === Ce ? (t.flags = s & ~Hn | Ee, t) : null;
        }
        case I:
          return Eg(t), null;
        case Fe: {
          ...
          var p = t.flags;
          return p & Hn ? (t.flags = p & ~Hn | Ee, (t.mode & mt) !== xe && Xg(t), t) : null;
        }
        case Wt:
          return uf(t), null;
        case ee:
    ...
    function Vw() {
      for (; ve !== null; ) {
        var e = ve, t = e.child;
        (e.subtreeFlags & Wi) !== Ce && t !== null ? (t.return = e, ve = t) : Bw();
      }
    }
    function Bw() {
      for (; ve !== null; ) {
...
Learn more about data fetching with Hooks: https://reactjs.org/link/hooks-data-fetching` : m = " You returned: " + p, g("%s must not return anything besides a function, which is used for clean-up.%s", v, m);
    ...
    function Yw(e, t, a, i) {
      if ((a.flags & Xi) !== Ce)
        switch (a.tag) {
          ...
          case lt: {
            {
              var O = a.memoizedProps, M = O.onCommit, L = O.onRender, re = a.stateNode.effectDuration, Re = qE(), Se = t === null ? "mount" : "update";
              KE() && (Se = "nested-update"), typeof L == "function" && L(a.memoizedProps.id, Se, a.actualDuration, a.treeBaseDuration, a.actualStartTime, Re);
              {
                typeof M == "function" && M(a.memoizedProps.id, Se, re, Re), Bb(a);
                var dt = a.return;
                e: for (; dt !== null; ) {
                  switch (dt.tag) {
                    case Y:
                      var at = dt.stateNode;
                      at.effectDuration += re;
                      break e;
                    case lt:
                      var b = dt.stateNode;
                      b.effectDuration += re;
    ...
    function Qw(e, t) {
      for (var a = null, i = e; ; ) {
        ...
        } else if (!((i.tag === G || i.tag === ye) && i.memoizedState !== null && i !== e)) {
          if (i.child !== null) {
            i.child.return = i, i = i.child;
            continue;
          }
      ...
      switch (e.tag) {
        ...
        case G: {
          ...
          if (hl(e), u & En) {
            ...
            if (z.isHidden = $, $ && !at && (se.mode & qe) !== xe) {
              ve = se;
    ...
    function $C(e, t, a) {
      for (var i = (e.mode & qe) !== xe; ve !== null; ) {
        var u = ve, s = u.child;
        if (u.tag === G && i) {
        ...
        (u.subtreeFlags & Xi) !== Ce && s !== null ? (s.return = u, ve = s) : _S(e, t, a);
      }
    }
    function _S(e, t, a) {
      for (; ve !== null; ) {
    ...
    function ab(e, t, a, i) {
      for (; ve !== null; ) {
        var u = ve, s = u.child;
        (u.subtreeFlags & yi) !== Ce && s !== null ? (s.return = u, ve = s) : ib(e, t, a, i);
      }
    }
    function ib(e, t, a, i) {
      for (; ve !== null; ) {
    ...
    function ob() {
      for (; ve !== null; ) {
        ...
        (e.subtreeFlags & yi) !== Ce && t !== null ? (t.return = e, ve = t) : sb();
      }
    }
    function sb() {
      for (; ve !== null; ) {
    ...
    function cb(e) {
      switch (e.tag) {
        ...
        case Me:
        case $e: {
          e.mode & mt ? (Gg(), Mi(Sr | qn, e, e.return), Wg(e)) : Mi(Sr | qn, e, e.return);
          break;
        }
      }
    }
    ...
    function pb(e, t) {
      switch (e.tag) {
        ...
        case Me:
        case $e: {
          e.mode & mt ? (Gg(), Mi(Sr, e, t), Wg(e)) : Mi(Sr, e, t);
          break;
        }
      }
    }
    ...
    var xb = Math.ceil, OS = k.ReactCurrentDispatcher, NS = k.ReactCurrentOwner, Tr = k.ReactCurrentBatchConfig, Ui = k.ReactCurrentActQueue, tr = (
      /*             */
      0
    ), WC = (
      /*               */
      ...
      /*                */
      4
    ), iu = 0, Tp = 1, Es = 2, Cm = 3, Rp = 4, GC = 5, MS = 6, ft = tr, qr = null, vn = null, nr = A, ml = A, LS = Bu(A), rr = iu, wp = null, xm = A, bp = A, Tm = A, Dp = null, Sa = null, zS = 0, XC = 500, KC = 1 / 0, Tb = 500, lu = null;
    function kp() {
      KC = Mn() + Tb;
    }
    function qC() {
    ...
    var Rm = !1, US = null, mf = null, Cs = !1, Zu = null, _p = A, AS = [], jS = null, Rb = 50, Op = 0, FS = null, HS = !1, wm = !1, wb = 50, yf = 0, bm = null, Np = jt, Dm = A, ZC = !1;
    function km() {
      return qr;
    }
    function Zr() {
    ...
    function bb(e) {
      var t = e.mode;
      return (t & qe) === xe ? Ne : Mv();
    }
    function ar(e, t, a, i) {
      Kb(), ZC && g("useInsertionEffect must not schedule updates."), HS && (wm = !0), Ou(e, a, i), (ft & Rr) !== A && e === qr ? Jb(t) : (Lr && Io(e, t, a), eD(t), e === qr && ((ft & Rr) === tr && (bp = Ie(bp, a)), rr === Rp && eo(e, nr)), Ea(e, i), a === Ne && ft === tr && (t.mode & qe) === xe && // Treat `act` as if it's inside `batchedUpdates`, even in legacy mode.
    ...
    function JC(e, t) {
      ...
      if (u === A)
        return null;
      var s = !Dc(e, u) && !Nv(e, u) && !t, f = s ? Fb(e, u) : Om(e, u);
      if (f !== iu) {
        if (f === Es) {
          var p = bc(e);
          p !== A && (u = p, f = VS(e, p));
      ...
      switch (t) {
        ...
        case Rp: {
          if (eo(e, a), yd(a))
            break;
          if (!hx()) {
            var f = Na(e, a), p = f, v = Mn() - p, m = Xb(v) - v;
            if (m > 10) {
    ...
    function rx(e, t) {
      do {
        var a = vn;
        try {
          if (Hh(), DE(), rn(), NS.current = null, a === null || a.return === null) {
            rr = Tp, wp = t, vn = null;
            return;
          }
    ...
    function Fb(e, t) {
      ...
      while (!0);
      return Hh(), ix(i), ft = a, vn !== null ? (Dv(), iu) : (lc(), qr = null, nr = A, rr);
    }
    function Hb() {
      for (; vn !== null && !nd(); )
        lx(vn);
    ...
    function lx(e) {
      ...
      Pt(e);
      var a;
      (e.mode & mt) !== xe ? (Qg(e), a = YS(t, e, ml), vm(e, !0)) : a = YS(t, e, ml), rn(), e.memoizedProps = e.pendingProps, a === null ? ux(e) : vn = a, NS.current = null;
    }
    function ux(e) {
      var t = e;
      do {
    ...
    function Vb(e, t, a, i) {
      ...
      if (p || v) {
        ...
        Rn(pr);
        var R = ft;
        ft |= ri, NS.current = null, Hw(e, u), ZE(), Jw(e, u, s), ZT(e.containerInfo), e.current = u, No(s), eb(u, e, s), Mo(), rd(), ft = R, Rn(y), Tr.transition = m;
      } else
        e.current = u, ZE();
      var x = Cs;
      if (Cs ? (Cs = !1, Zu = e, _p = s) : (yf = 0, bm = null), f = e.pendingLanes, f === A && (mf = null), x || fx(e.current, !1), id(u.stateNode, i), Lr && e.memoizedUpdaters.clear(), Sb(), Ea(e, Mn()), t !== null)
        for (var O = e.onRecoverableError, M = 0; M < t.length; M++) {
          var L = t[M], re = L.stack, Re = L.digest;
          O(L.value, {
            componentStack: re,
            digest: Re
          });
      ...
      return Ur(_p, Ne) && e.tag !== Pu && ou(), f = e.pendingLanes, Ur(f, Ne) ? (I1(), e === FS ? Op++ : (Op = 0, FS = e)) : Op = 0, $u(), sd(), null;
    }
    function ou() {
      if (Zu !== null) {
    ...
    function Pb() {
      ...
      HS = !0, wm = !1, Al(a);
      var i = ft;
      ft |= ri, ub(t.current), rb(t, t.current, a, e);
      {
        var u = AS;
        AS = [];
      ...
      dd(), fx(t.current, !0), ft = i, $u(), wm ? t === bm ? yf++ : (yf = 0, bm = t) : yf = 0, HS = !1, wm = !1, ld(t);
      {
    ...
    var Ib = Yb;
    function sx(e, t, a) {
      var i = gs(a, t), u = lC(e, i, Ne), s = Iu(e, u, Ne), f = Zr();
      ...
      for (i = t; i !== null; ) {
        if (i.tag === Y) {
          ...
          if (typeof u.getDerivedStateFromError == "function" || typeof s.componentDidCatch == "function" && !ox(s)) {
            var f = gs(a, e), p = cS(i, f, Ne), v = Iu(i, p, Ne), m = Zr();
...
%s`, a);
    ...
    function Qb(e, t, a) {
      ...
      i !== null && i.delete(t);
      var u = Zr();
      kc(e, a), tD(e), qr === e && Il(nr, a) && (rr === Rp || rr === Cm && Yl(nr) && Mn() - zS < XC ? xs(e, A) : Tm = Ie(Tm, a)), Ea(e, u);
    }
    function cx(e, t) {
      t === vt && (t = bb(e));
      var a = Zr(), i = ya(e, t);
    ...
    function fx(e, t) {
      Pt(e), Nm(e, Qi, mb), t && Nm(e, $a, yb), Nm(e, Qi, vb), t && Nm(e, $a, hb), rn();
    }
    function Nm(e, t, a) {
    ...
    function dx(e) {
      {
        if ((ft & Rr) !== tr || !(e.mode & qe))
          return;
        var t = e.tag;
        if (t !== Oe && t !== Y && t !== Z && t !== J && t !== Me && t !== Tt && t !== $e)
          return;
      ...
      YS = function(e, t, a) {
        ...
        try {
          ...
          if (c1() || s !== null && typeof s == "object" && typeof s.then == "function")
            throw s;
          if (Hh(), DE(), NC(e, t), Ex(t, i), t.mode & mt && Qg(t), Ii(null, wC, null, e, t, a), hi()) {
            var u = bo();
    ...
    function eD(e) {
      {
        if (e.mode & qe) {
          if (!QC())
            return;
        } else if (!Cb() || ft !== tr || e.tag !== J && e.tag !== Me && e.tag !== $e)
          return;
        if (Ui.current === null) {
          var t = dr;
          try {
...
This ensures that you're testing the behavior the user would see in the browser. Learn more at https://reactjs.org/link/wrap-tests-with-act`);
    ...
    function dD(e, t, a) {
      var i;
      return e === _h ? (i = qe, t === !0 && (i |= Mt, i |= yt)) : i = xe, Lr && (i |= mt), Ua(Y, null, null, i);
    }
...
Check the render method of \`` + m + "`.");
    ...
    function gD(e, t, a, i, u) {
      this.tag = t, this.containerInfo = e, this.pendingChildren = null, this.current = null, this.pingCache = null, this.finishedWork = null, this.timeoutHandle = Fy, this.context = null, this.pendingContext = null, this.callbackNode = null, this.callbackPriority = vt, this.eventTimes = Yo(A), this.expirationTimes = Yo(jt), this.pendingLanes = A, this.suspendedLanes = A, this.pingedLanes = A, this.expiredLanes = A, this.mutableReadLanes = A, this.finishedLanes = A, this.entangledLanes = A, this.entanglements = Yo(A), this.identifierPrefix = i, this.onRecoverableError = u, this.mutableSourceEagerHydrationData = null, this.effectDuration = 0, this.passiveEffectDuration = 0;
      {
    ...
    function Rx(e, t, a, i, u, s, f, p, v, m) {
      ...
      return L.callback = t ?? null, Iu(x, L, M), Db(R, M, O), R;
    }
    function Up(e, t, a, i) {
      ad(t, e);
...
function nk() {
  const H = ak(), K = /^#\/element\/(.+)$/.exec(H);
  return /* @__PURE__ */ me.jsx("div", { className: "karyotype_viewer_main ", children: /* @__PURE__ */ me.jsx(rk, { route: H, children: K ? /* @__PURE__ */ me.jsx(lk, { elementId: decodeURIComponent(K[1]) }) : /* @__PURE__ */ me.jsx(ik, {}) }) });
}
...
function ak() {
  const [H, K] = no(() => window.location.hash || "#/");
  return Ta(() => {
...
function ik() {
  const [H, K] = no(null), [k, it] = no(null), [we, Ve] = no("(none)"), [g, Ae] = no("(none)"), [J, Z] = no(!1);
  Ta(() => {
    ...
    Y && (K(Y), Ve(I || "(saved)")), ee && (it(ee), Ae(fe || "(saved)"));
  }, []), Ta(() => {
    try {
  ...
  const Oe = (Y) => {
    const ee = Array.from(Y), I = (be) => ee.find((tt) => be.some((Je) => tt.name.toLowerCase().endsWith(Je))), fe = I([".txt", ".tsv", ".csv"]), Te = I([".bed", ".txt"]);
    if (fe) {
      const be = new FileReader();
      be.onload = () => {
        K(String(be.result || "")), Ve(fe.name);
      }, be.readAsText(fe);
    }
    if (Te) {
      const be = new FileReader();
      be.onload = () => {
        it(String(be.result || "")), Ae(Te.name);
      }, be.readAsText(Te);
    }
  };
  return Ta(() => {
    async function Y() {
      try {
        ...
        K(I), Ve("/static/karyotype_viewer/human_karyotype.txt");
        const Te = await (await fetch(`/static/karyotype_viewer/compiled.bed?ts=${Date.now()}`)).text();
        it(Te), Ae("/static/karyotype_viewer/compiled.bed");
      } catch (ee) {
        console.error("Error loading static files", ee);
      }
    }
    Y();
  }, []), /* @__PURE__ */ me.jsx("div", { className: "main-grid grid grid-cols-1 lg:grid-cols-12 gap-4", children: /* @__PURE__ */ me.jsx("div", { className: "col-left lg:col-span-9", children: /* @__PURE__ */ me.jsx(uk, { karyoText: H, bedText: k, onDropFiles: Oe }) }) });
}
function lk({ elementId: H }) {
  ...
  return /* @__PURE__ */ me.jsxs("div", { className: "bg-white rounded-2xl shadow p-6", children: [
    ...
    /* @__PURE__ */ me.jsxs("h1", { className: "mt-2 text-2xl font-semibold", children: [
      "Element: ",
      /* @__PURE__ */ me.jsx("span", { className: "font-mono text-base px-2 py-1 rounded bg-gray-100 break-all", children: H })
    ] }),
...
function uk({ karyoText: H, bedText: K, onDropFiles: k }) {
  const it = ws(null), we = ws(null), Ve = ws(null), g = ws(!1), [Ae, J] = no(() => sessionStorage.getItem("selected_element") || null);
  Ta(() => {
    const Q = () => J(null);
    return window.addEventListener("kv-clear-all", Q), () => window.removeEventListener("kv-clear-all", Q);
  }, []);
  const Z = ws({ x: 0, y: 0, s: 1 }), Oe = ws(!1), Y = ws({ x: 0, y: 0, tx: 0, ty: 0 }), ee = (Q, G, ye) => {
    Z.current = { x: Q, y: G, s: ye };
    const Xe = Ve.current;
    Xe && Xe.setAttribute("transform", `translate(${Q},${G}) scale(${ye})`);
  }, I = () => {
    const Q = we.current, G = Ve.current;
    if (!(!Q || !G))
      try {
        const ye = G.getBBox();
        if (!isFinite(ye.width) || !isFinite(ye.height) || ye.width === 0 || ye.height === 0) return;
        const Xe = Q.clientWidth || 1e3, pt = Q.clientHeight || 600, Ft = 20, X = (Xe - 2 * Ft) / ye.width, ge = (pt - 2 * Ft) / ye.height, q = Math.min(X, ge), Ze = Ft - ye.x * q + (Xe - (ye.width * q + 2 * Ft)) / 2, nt = Ft - ye.y * q + (pt - (ye.height * q + 2 * Ft)) / 2;
        ee(Ze, nt, q);
      } catch {
      }
  }, fe = (Q, G, ye) => {
    const { x: Xe, y: pt, s: Ft } = Z.current, X = pk(Ft * Q, 0.3, 200), ge = (G - Xe) / Ft, q = (ye - pt) / Ft, Ze = G - ge * X, nt = ye - q * X;
    ee(Ze, nt, X);
  }, Te = (Q) => {
    Q.preventDefault();
    const G = Math.exp(-Q.deltaY * 1e-3), ye = Q.currentTarget.getBoundingClientRect();
    fe(G, Q.clientX - ye.left, Q.clientY - ye.top);
  }, be = (Q) => {
    const G = we.current;
    if (!G) return;
    const ye = Q.target;
    if (!(ye && typeof ye.getAttribute == "function" && ye.getAttribute("data-el") === "1")) {
      Oe.current = !0;
      try {
        G.setPointerCapture(Q.pointerId);
      } catch {
      }
    ...
    const G = Q.clientX - Y.current.x, ye = Q.clientY - Y.current.y;
    ee(Y.current.tx + G, Y.current.ty + ye, Z.current.s);
  }, Je = (Q) => {
    const G = we.current;
    if (G) {
      Oe.current = !1;
      try {
        G.releasePointerCapture(Q.pointerId);
      } catch {
      }
    }
  }, Me = Vp(() => H ? ck(H) : [], [H]), lt = Vp(() => K ? fk(K) : [], [K]);
  Ta(() => {
    g.current = !1;
  }, [Me, lt]);
  const Fe = Vp(() => Array.from(new Set(lt.map((Q) => Q.family))), [lt]), [Tt, $e] = no(/* @__PURE__ */ new Set()), ln = Vp(() => {
    const Q = /* @__PURE__ */ new Map();
    return Fe.forEach((G, ye) => Q.set(G, dk(ye, Fe.length || 1))), Q;
  }, [Fe]);
  Ta(() => {
    $e(new Set(Fe));
  }, [Fe]), Ta(() => {
    const Q = "http://www.w3.org/2000/svg", G = we.current;
    if (!G) return;
    for (; G.firstChild; ) G.removeChild(G.firstChild);
    const ye = document.createElementNS(Q, "defs");
    G.appendChild(ye);
    const Xe = document.createElementNS(Q, "g");
    if (G.appendChild(Xe), Ve.current = Xe, !Me.length) return;
    const pt = new Map(Me.map((Ue) => [Ue.key, Ue])), Ft = Me.map((Ue) => Ue.key), X = Ft.length, q = Math.ceil(X / 14), Ze = Math.floor(X / q), nt = X % q, Yn = [];
    let un = 0;
    for (let Ue = 0; Ue < q; Ue++) {
      const At = Ze + (Ue < nt ? 1 : 0);
      Yn.push(Ft.slice(un, un + At)), un += At;
    }
    const ta = 16, hn = 340, mn = 80, kn = 20, ir = 40, Un = /* @__PURE__ */ new Map(), yn = Me.reduce((Ue, At) => Math.max(Ue, At.end - At.start), 1), cr = (Ue, At, Ct) => (_t) => At + (_t - Ue.start) / (Ue.end - Ue.start) * Ct;
    Yn.forEach((Ue, At) => {
      Ue.forEach((Ct, _t) => {
        const Ot = pt.get(Ct);
        if (!Ot) return;
        const Nt = (Ot.end - Ot.start) / yn * 280 + 40, tn = ir + _t * mn, nn = kn + At * hn, Fn = cr(Ot, nn, Nt);
        Un.set(Ct, { x: tn, y: nn, height: Nt, scale: Fn, k: Ot });
      });
    });
    for (const [Ue, At] of Un) {
      const { x: Ct, y: _t, height: Ot, k: jn, scale: Nt } = At, tn = Nt(jn.ceStart), nn = Nt(jn.ceEnd), Fn = sk(Ct, _t, Ot, ta, tn, nn), gn = document.createElementNS(Q, "path");
      gn.setAttribute("d", Fn), gn.setAttribute("fill", "#e5e7eb"), gn.setAttribute("stroke", "#9ca3af"), gn.setAttribute("stroke-width", "1"), gn.setAttribute("shape-rendering", "geometricPrecision"), Xe.appendChild(gn);
      const W = `clip-${Ue}`, ie = document.createElementNS(Q, "clipPath");
      ie.setAttribute("id", W);
      const Be = document.createElementNS(Q, "path");
      Be.setAttribute("d", Fn), ie.appendChild(Be), ye.appendChild(ie);
      const Ge = document.createElementNS(Q, "g");
      Ge.setAttribute("clip-path", `url(#${W})`), Xe.appendChild(Ge);
      const ut = document.createElementNS(Q, "text");
      ut.setAttribute("x", String(Ct + ta / 2)), ut.setAttribute("y", String(_t + Ot + 16)), ut.setAttribute("text-anchor", "middle"), ut.setAttribute("font-size", "12"), ut.setAttribute("fill", "#374151"), ut.textContent = jn.label, Xe.appendChild(ut), At.gChr = Ge;
    }
    ...
    const bt = document.createElementNS(Q, "rect");
    ...
    for (const Ue of lt) {
      ...
      if (!At) continue;
      const { k: Ct, scale: _t } = At, Ot = Math.max(Ct.start, Math.min(Ue.start, Ct.end)), jn = Math.max(Ct.start, Math.min(Ue.end + 1, Ct.end + 1)), Nt = _t(Ot), tn = _t(jn), nn = `${pt.get(Ue.key).label}:${Ue.start}-${Ue.end}:${Ue.name}`.replace(/\s+/g, "_");
    ...
    for (const [Ue, At] of on) {
      const Ct = Un.get(Ue);
      if (!Ct) continue;
      const { x: _t, y: Ot, height: jn, gChr: Nt } = Ct, tn = 16 - 2 * Ra, nn = Math.min(tn, Math.max(ja, tn)), Fn = _t + (16 - nn) / 2, gn = At.slice().sort((W, ie) => W.yTop - ie.yTop || W.yBot - W.yTop - (ie.yBot - ie.yTop));
      for (let W = 0; W < gn.length; W++) {
        const { b: ie, id: Be } = gn[W];
        let Ge = Math.max(Ot, Math.min(Ot + jn, gn[W].yTop)), ut = Math.max(Ge, Math.min(Ot + jn, gn[W].yBot));
        const ht = document.createElementNS(Q, "rect");
        ht.setAttribute("x", String(Fn)), ht.setAttribute("width", String(nn)), ht.setAttribute("y", String(Ge)), ht.setAttribute("height", String(Math.max(1, ut - Ge))), ht.setAttribute("fill", ln.get(ie.family) || "#10b981"), ht.setAttribute("stroke", "none"), ht.setAttribute("cursor", "pointer"), ht.setAttribute("pointer-events", "all"), ht.setAttribute("data-el", "1"), ht.addEventListener("pointerdown", (xt) => xt.stopPropagation()), ht.addEventListener("pointerenter", () => {
          bt.setAttribute("x", String(Fn)), bt.setAttribute("y", String(Ge)), bt.setAttribute("width", String(nn)), bt.setAttribute("height", String(Math.max(1, ut - Ge))), bt.setAttribute("visibility", "visible"), Nt.appendChild(bt);
        }), ht.addEventListener("pointerleave", () => {
          bt.setAttribute("visibility", "hidden");
        }), ht.addEventListener("click", () => {
          window.open("/repeatTable/" + ie.family, "_blank");
        });
        const Bt = document.createElementNS(Q, "title"), _n = pt.get(ie.key);
        if (Bt.textContent = `${ie.name} — ${ie.family}
${_n ? _n.label : ie.key}:${ie.start}-${ie.end}`, ht.appendChild(Bt), Nt.appendChild(ht), Ae && Be === Ae) {
          const xt = { x: Fn, w: nn, y: Ge, h: Math.max(1, ut - Ge) }, ot = document.createElementNS(Q, "rect");
          ot.setAttribute("fill", "none"), ot.setAttribute("stroke", "#111827"), ot.setAttribute("stroke-width", "2"), ot.setAttribute("vector-effect", "non-scaling-stroke"), ot.setAttribute("pointer-events", "none"), ot.setAttribute("x", String(xt.x)), ot.setAttribute("y", String(xt.y)), ot.setAttribute("width", String(xt.w)), ot.setAttribute("height", String(xt.h)), Nt.appendChild(ot);
        }
      }
    }
    ...
    if (!Q) return;
    const G = (ye) => {
      ye.preventDefault(), Math.pow(1.0015, ye.deltaY);
      const Xe = Q.getBoundingClientRect();
      (ye.clientX - Xe.left) / Xe.width, (ye.clientY - Xe.top) / Xe.height;
    };
    return Q.addEventListener("wheel", G, { passive: !1 }), () => {
      Q.removeEventListener("wheel", G);
    };
  }, []);
  const Ut = () => {
    const Q = we.current;
    ...
    fe(1.2, G.width / 2, G.height / 2);
  }, en = () => {
    const Q = we.current;
    if (!Q) return;
    const G = Q.getBoundingClientRect();
    fe(1 / 1.2, G.width / 2, G.height / 2);
  }, Wt = () => {
    I();
  };
  return /* @__PURE__ */ me.jsxs("div", { ref: it, className: "kary_card bg-white rounded-2xl shadow overflow-hidden", children: [
    ...
    /* @__PURE__ */ me.jsxs("div", { className: "kary_graph_holder grid grid-cols-12", children: [
      /* @__PURE__ */ me.jsx("div", { className: "kary_graph col-span-9 border-r", children: /* @__PURE__ */ me.jsxs("div", { className: "kary_svg_holder relative w-full h-full bg-gray-50", children: [
        ...
        !ok(Me) && !lt.length && /* @__PURE__ */ me.jsx("div", { className: "absolute inset-0 grid place-items-center pointer-events-none", children: /* @__PURE__ */ me.jsxs("div", { className: "text-center text-gray-500", children: [
      ...
      /* @__PURE__ */ me.jsx("div", { className: "col-span-3 max-h-[72vh] overflow-auto p-3", children: Fe.length ? /* @__PURE__ */ me.jsx("div", { className: "karyo_btns space-y-2", children: Fe.map((Q) => /* @__PURE__ */ me.jsxs("button", { onClick: () => {
        const G = new Set(Tt);
        G.has(Q) ? G.delete(Q) : G.add(Q), $e(G);
        ...
        /* @__PURE__ */ me.jsx("span", { className: "inline-block w-5 h-5" }),
        /* @__PURE__ */ me.jsx("span", { className: "text-sm font-medium flex-1 text-left", children: Q })
      ] }, Q)) }) : /* @__PURE__ */ me.jsx("div", { className: "text-sm text-gray-500 p-2", children: "Legend appears after loading a BED (column 5 = family)." }) })
    ] })
  ] });
}
function ok(H) {
...
function sk(H, K, k, it, we, Ve) {
  const g = H + it / 2, Ae = H, J = H + it, Z = K, Oe = K + k;
  let Y = Math.max(Z, Math.min(we, Ve)), ee = Math.min(Oe, Math.max(we, Ve));
  const I = 4, fe = it * 0.45, Te = Math.min(fe * 0.25, 6), be = Math.max(Y, Z + I), tt = Math.min(ee, Oe - I);
  return [
    `M ${Ae} ${Z + I}`,
    `Q ${Ae} ${Z} ${Ae + I} ${Z}`,
    `L ${J - I} ${Z}`,
    ...
    `Q ${Ae} ${Oe} ${Ae} ${Oe - I}`,
    `L ${Ae} ${tt + Te}`,
    `Q ${Ae} ${tt} ${g - fe / 2 - Te} ${tt}`,
    `Q ${g - fe / 2} ${tt} ${g - fe / 2} ${tt - Te}`,
    `L ${g - fe / 2} ${be + Te}`,
...
function ck(H) {
  const K = [], k = String(H).split(/\r?\n/);
  for (let it = 0; it < k.length; it++) {
    const we = String(k[it] || "").trim();
    ...
    const [Z, Oe, Y, ee, I] = Ve, fe = String(Z).trim(), Te = uT(fe), be = Hm(Oe), tt = Hm(Y), Je = Hm(ee), Me = Hm(I);
    [be, tt, Je, Me].some((lt) => !isFinite(lt)) || K.push({ key: Te, label: fe, start: be, end: tt, ceStart: Je, ceEnd: Me });
  }
  return K;
}
function fk(H) {
  ...
  for (const it of k) {
    ...
    const fe = ee + 1, Te = I;
    K.push({ key: Y, start: fe, end: Te, name: Z, family: Oe, raw: we });
  }
  return K;
}
function dk(H, K) {
  return `hsl(${H * 360 / Math.max(1, K) % 360} 70% 45%)`;
}
function pk(H, K, k) {
  return Math.max(K, Math.min(k, H));
}
function Hm(H) {
...
const vk = m0(oT);
vk.render(
  /* @__PURE__ */ me.jsx(Cf.StrictMode, { children: /* @__PURE__ */ me.jsx(nk, {}) })
);
